import { CloudIcon, BookOpenIcon, CashIcon } from '@heroicons/react/solid'
...
export function FeaturesPanel() {
  return (
    <div className="overflow-hidden  py-24 sm:py-32 " style={{backgroundColor:"#212121", height: "100vh"}}>
