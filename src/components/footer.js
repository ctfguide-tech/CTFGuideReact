  ...
  return (
    <footer style={{backgroundColor:"#161716"}} >
       ...
       <img src="darkLogo.png" className="w-14 mx-auto text-center" /> 
          <nav className="mt-4 text-sm" aria-label="quick as">
            <div className="-my-1 flex place-content-center gap-x-6 text-white">
              <a href="../terms-of-service">Terms of Service</a>
              <a href="../privacy-policy">Privacy Policy</a>
              <a href="https://status.ctfguide.com/">Status</a>
