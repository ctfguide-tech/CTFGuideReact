      ...
      <main className="mt-3" >
        ...
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8   ">
          ...
          <div className="text-white">
            <br></br>
            <h1 className="text-4xl font-semibold ">Using wget</h1>
            <p className="text-xl mt-3">
              In this lesson you will learn how to use wget to download files on to your machine

              <br></br><br></br>

              What is wget?       wget is Linux/Unix command line utility used to download content from a url that supports FTP, STFTP, HTTP/S, XHTML. 
              <br></br>
              <br></br><br></br>

              How to use wget?       There are many ways to use wget to download diffrent types of content. Default:  'wget [option] | [URL].', Website Content: 'wget --mirror --convert/-links --page-requisites --no-parent -P documents/websites/ https://some-website.com'. For more information you can use 'wget help'.
              <br></br>
