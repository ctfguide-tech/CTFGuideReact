      ...
      <main className="mt-3" >
        ...
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8   ">
          ...
          <div className="text-white">
            <br></br>
            <h1 className="text-4xl font-semibold ">Linux Basics</h1>
            <p className="text-xl mt-3">
              Welcome to Linux Basics where you learn basic commands to help you with Linux! Now we will be working with Debian instead of much harder to understand distribution. 

              <br></br><br></br>

              What you will learn?        In this lesson you will learn how to connect to servers, file navigation, wget, curl and more!
              <br></br>
            </p>
