      ...
      <main className="mt-3" >
        ...
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8   ">
          ...
          <div className="text-white">
            ...
            <p className="mt-6"><i class="fas fa-pencil-alt"></i> &nbsp;Written by Pranav Ramesh &nbsp;<span className="text-sm bg-green-700 px-2 py-0.5 rounded-lg"><i class="fas fa-check-circle"></i>&nbsp;CTFGuide Employee</span> </p>
          </div>
