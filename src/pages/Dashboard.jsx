            ...
            <div className="lg:col-span-2 sm:col-span-1">
              ...
              >
                ...
                <p className="text-white mt-2" style={{ color: "#8c8c8c" }}>
                  Heads up, we're slowly rebuilding some services on this website. You might accidentally stumble into some problems.

                  <br></br>

                  <p className="underline bold mt-4 mb-2" >Known Problems</p>
                  <ul>
                    <li>- Lessons can sometimes redirect you to a black screen. For now, just manually reload your screen.</li>
                    <li>- Your points may be stuck on a loader if you're on mobile.</li>
                    <li>- Unreleased features like "Friends" are shown in places like the dashboard..</li>
